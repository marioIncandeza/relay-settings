    ...
    try:
        ...
        for i, relay in enumerate(relay_class[1:]):
            if relay[0] is not None:
                ...
                # Generate RDB .txt file
                os.chdir(output_paths[i])
                if workbook_params['sheet_name'] == "XFMR_487E":
                    update_template_487E(word_bits)
                else:
...
if __name__ == '__main__':
    ...
    template_path = r"C:\Users\laerps\OneDrive - Westwood Active Directory\Desktop\351S\487E Template"
    output_path = r"C:\Users\laerps\OneDrive - Westwood Active Directory\Desktop\351S"
    gen_settings(xl_path, template_path, output_path, {'sheet_name': "XFMR_487E", 'class_table': 'class_487E', 'settings_table': "settings_487E"})
